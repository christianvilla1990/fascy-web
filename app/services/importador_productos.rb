...
class ImportadorProductos
  ...
  def importar(codigo_cliente: 'string', product_id: '')
    importar_productos(codigo_cliente: codigo_cliente, product_id: product_id)
  end
...
# ...existing code..
    ...
    items.each do |i|
      ...
      # Asignar caracteristicas si existe la columna
